...
class PromptModule(nn.Module):
    def __init__(self, basic_dim=32, dim=32, input_resolution=128):
        ...
        self.Dino_low = frequenctSpecificPromptGenetator(basic_dim, h, w, flag_highF=False)
        ...
        self.modulator_dino = lowFrequencyPromptFusion(dim, basic_dim, win_size=8, num_heads=2, bias=False)
