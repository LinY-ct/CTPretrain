...
from models.Restormer_GGB3_Encoder import GGB
...
class Restore_RWKV_GGB3_Encoder(FBPTools):
    def __init__(self,
                 inp_channels=3,
                 out_channels=3,
                 dim=48,
        ...
        super(Restore_RWKV_GGB3_Encoder, self).__init__()

        self.patch_embed = nn.Conv2d(inp_channels, dim, kernel_size=3, stride=1, padding=1, bias=True)

        self.fre1 = GGB(dim, num_heads=2, bias=False)
        self.fre2 = GGB(dim * 2 ** 1, num_heads=2, bias=False)
        self.fre3 = GGB(dim * 2 ** 2, num_heads=2, bias=False)
        self.fre4 = GGB(dim * 2 ** 3, num_heads=2, bias=False)
