...
class dinov2_decoder(FBPTools):
    def __init__(self, embed_dim=768, decoder_embed_dim=512,  num_patches=256,mlp_ratio=4.,decoder_depth=8,
        ...
        super(dinov2_decoder, self).__init__()
        self.dinov2_model = torch.hub.load('/home/wsy/.cache/torch/hub/facebookresearch_dinov2_main', 'dinov2_vitb14', source='local',pretrained=True)
