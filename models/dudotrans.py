...
class dudotrans(FBPTools):
    ...
    def forward(self, sparse_sinogram_mu, img_mu):
        sinos_enhanced = self.Sinogram_recon_module(sparse_sinogram_mu)
        img_ril_mu = self.radon(sinos_enhanced)
        img_input_mu = torch.cat((img_mu, img_ril_mu), 1)
        reconstructed_img_mu = self.Image_recon_module(img_input_mu)
        return sinos_enhanced, img_ril_mu, reconstructed_img_mu
