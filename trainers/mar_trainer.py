...
class mar_trainer(BasicTrainer):
    def __init__(self, opt, net):
        ...
        if dataset_name == 'mar':
            self.train_dataset = MARDataset(opt.dataset_path, mode='train', 
                                            dataset_shape=opt.dataset_shape,use_num=opt.num_train)
            self.val_dataset = MARDataset(opt.dataset_path, mode='val', 
                                          dataset_shape=opt.dataset_shape,use_num=opt.num_val)
        else:
