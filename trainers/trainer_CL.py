...
from utilities.loss import ContrastLoss
...
class trainer_CL(BasicTrainer):
    ...
    def train(self):
        ...
        for i, data in enumerate(pbar):
            ...
            negative_CT_mu = torch.zeros((b, 5 - 1, 3, w, h))
            for j in ("ld", 'sv', 'lv','ld_sv', 'ld_lv'):
                k = 0
                if (j == degenetaion_type[0]):
