...
from utilities.loss import GGB3CL,ContrastLoss
...
class trainer_GGB3CLAndCL(BasicTrainer):
    def __init__(self, opt, net):
        ...
        self.CL = ContrastLoss().cuda()
        self.GGB3CL = GGB3CL().cuda()
    ...
    def train(self):
        ...
        for i, data in enumerate(pbar):
            ...
            loss = 0.6 * self.criterion(restored, gt_CT_norm) + 0.25 * self.CL(ma_CT_norm,gt_CT_norm,negative_CT_norm,
                                                             restored)+ 0.2 * self.GGB3CL(ma_CT_norm,gt_CT_norm,negative_CT_norm,
                                                             restored)
