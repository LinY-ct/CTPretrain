...
class trainer_PIP_V3(BasicTrainer):
    def __init__(self, opt, net):
        ...
        # self.dinov2_model = torch.hub.load('/home/wsy/.cache/torch/hub/facebookresearch_dinov2_main',
        #                                    'dinov2_vitb14', source='local',pretrained=True).cuda()
    ...
    def train(self):
        ...
        for i, data in enumerate(pbar):
            ...
            # dino_HQ_Features = self.dinov2_model.get_intermediate_layers(F.interpolate(gt_CT_norm, size=(224, 224),
            #                                            mode='bilinear', align_corners=False), n=[11], reshape=False)
